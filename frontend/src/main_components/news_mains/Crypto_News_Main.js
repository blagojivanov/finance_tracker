...
import "../Main.css";
import Crypto_News_Card_1 from "../../menu_components/crypto_news/Crypto_News_cards_1";
import Crypto_News_Card_2 from "../../menu_components/crypto_news/Crypto_News_cards_2";
import Crypto_News_Card_3 from "../../menu_components/crypto_news/Crypto_News_cards_3";
import Crypto_News_Card_4 from "../../menu_components/crypto_news/Crypto_News_cards_4";
import Crypto_News_Card_5 from "../../menu_components/crypto_news/Crypto_News_cards_5";
import Crypto_News_Card_6 from "../../menu_components/crypto_news/Crypto_News_cards_6";
import Crypto_News_Card_7 from "../../menu_components/crypto_news/Crypto_News_cards_7";
import {CryptoData_1} from "../../crypto_cards_info/Crypto_cards_info_1";
import {SymbolsData} from "../../crypto_cards_info/Symbols";
import Chart from "react-apexcharts";
import {CryptoData} from "../news_info/Crypto_Info";
...
const randomNumber = Math.floor(Math.random() * (CryptoData.length - 7)) + 1;
...
export default function Crypto_News_Main() {
    ...
    const Crypto_News_card_1 = CryptoData.slice(randomNumber, randomNumber_1).map(item => {
        return (
            <Crypto_News_Card_1
                key={item.time}
                {...item}
    ...
    const Crypto_News_card_2 = CryptoData.slice(randomNumber_1, randomNumber_2).map(item => {
        return (
            <Crypto_News_Card_2
                key={item.time}
                {...item}
    ...
    const Crypto_News_card_3 = CryptoData.slice(randomNumber_2, randomNumber_3).map(item => {
        return (
            <Crypto_News_Card_3
                key={item.time}
                {...item}
    ...
    const Crypto_News_card_4 = CryptoData.slice(randomNumber_3, randomNumber_4).map(item => {
        return (
            <Crypto_News_Card_4
                key={item.time}
                {...item}
    ...
    const Crypto_News_card_5 = CryptoData.slice(randomNumber_4, randomNumber_5).map(item => {
        return (
            <Crypto_News_Card_5
                key={item.time}
                {...item}
    ...
    const Crypto_News_card_6 = CryptoData.slice(randomNumber_5, randomNumber_6).map(item => {
        return (
            <Crypto_News_Card_6
                key={item.time}
                {...item}
    ...
    const Crypto_News_card_7 = CryptoData.slice(randomNumber_6, randomNumber_7).map(item => {
        return (
            <Crypto_News_Card_7
                key={item.time}
                {...item}
