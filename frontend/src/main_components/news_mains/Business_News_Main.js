...
import {BusinessData} from "../news_info/Business_Info";
...
const randomNumber = Math.floor(Math.random() * (BusinessData.length - 7)) + 1;
...
export default function Business_News_Main() {
    ...
    const Business_News_card_1 = BusinessData.slice(randomNumber, randomNumber_1).map(item => {
        return (
    ...
    const Business_News_card_2 = BusinessData.slice(randomNumber_1, randomNumber_2).map(item => {
        return (
    ...
    const Business_News_card_3 = BusinessData.slice(randomNumber_2, randomNumber_3).map(item => {
        return (
    ...
    const Business_News_card_4 = BusinessData.slice(randomNumber_3, randomNumber_4).map(item => {
        return (
    ...
    const Business_News_card_5 = BusinessData.slice(randomNumber_4, randomNumber_5).map(item => {
        return (
    ...
    const Business_News_card_6 = BusinessData.slice(randomNumber_5, randomNumber_6).map(item => {
        return (
    ...
    const Business_News_card_7 = BusinessData.slice(randomNumber_6, randomNumber_7).map(item => {
        return (
