...
import "../Main.css";
import Policy_and_Regulations_News_Card_1
    from "../../menu_components/policy&regulations_news/Policy_and_Regulations_News_cards_1";
import Policy_and_Regulations_News_Card_2
    from "../../menu_components/policy&regulations_news/Policy_and_Regulations_News_cards_2";
import Policy_and_Regulations_News_Card_3
    from "../../menu_components/policy&regulations_news/Policy_and_Regulations_News_cards_3";
import Policy_and_Regulations_News_Card_4
    from "../../menu_components/policy&regulations_news/Policy_and_Regulations_News_cards_4";
import Policy_and_Regulations_News_Card_5
    from "../../menu_components/policy&regulations_news/Policy_and_Regulations_News_cards_5";
import Policy_and_Regulations_News_Card_6
    from "../../menu_components/policy&regulations_news/Policy_and_Regulations_News_cards_6";
import Policy_and_Regulations_News_Card_7
    from "../../menu_components/policy&regulations_news/Policy_and_Regulations_News_cards_7";
import {CryptoData_1} from "../../crypto_cards_info/Crypto_cards_info_1";
import {SymbolsData} from "../../crypto_cards_info/Symbols";
import Chart from "react-apexcharts";
import {PolicyData} from "../news_info/Policy_Info";
...
const randomNumber = Math.floor(Math.random() * (PolicyData.length - 7)) + 1;
...
export default function Policy_and_Regulations_News_Main() {
    ...
    const Policy_and_Regulations_News_card_1 = PolicyData.slice(randomNumber, randomNumber_1).map(item => {
        return (
    ...
    const Policy_and_Regulations_News_card_2 = PolicyData.slice(randomNumber_1, randomNumber_2).map(item => {
        return (
    ...
    const Policy_and_Regulations_News_card_3 = PolicyData.slice(randomNumber_2, randomNumber_3).map(item => {
        return (
    ...
    const Policy_and_Regulations_News_card_4 = PolicyData.slice(randomNumber_3, randomNumber_4).map(item => {
        return (
    ...
    const Policy_and_Regulations_News_card_5 = PolicyData.slice(randomNumber_4, randomNumber_5).map(item => {
        return (
    ...
    const Policy_and_Regulations_News_card_6 = PolicyData.slice(randomNumber_5, randomNumber_6).map(item => {
        return (
    ...
    const Policy_and_Regulations_News_card_7 = PolicyData.slice(randomNumber_6, randomNumber_7).map(item => {
        return (
