...
import {CryptoData_6, id} from "../crypto_cards_info/Crypto_cards_info_6";
...
export default function Crypto_cards_6(props) {

    const [chartData, setChartData] = useState({
        labels: CryptoData_6.map((data) => data.time),
        datasets: [
            {
                data: CryptoData_6.map((data) => data.close),
                borderColor: "green",
                borderWidth: 2,
