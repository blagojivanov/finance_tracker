...
import {CryptoData_3, id} from "../crypto_cards_info/Crypto_cards_info_3";
...
export default function Crypto_cards_3(props) {

    const [chartData, setChartData] = useState({
        labels: CryptoData_3.map((data) => data.time),
        datasets: [
            {
                data: CryptoData_3.map((data) => data.close),
                borderColor: "green",
                borderWidth: 2,
